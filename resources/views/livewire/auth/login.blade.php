<div>
    <h2 class="text-xl font-bold text-[#0F172A] mb-2 text-center">Welcome back</h2>
    <p class="text-sm text-[#64748B] mb-6 text-center">Log in to manage your WhatsApp orders.</p>
    ...
    <form wire:submit.prevent="login" class="space-y-4">
        ...
        <div class="flex items-center justify-between">
            <label class="flex items-center">
                <input type="checkbox" wire:model="remember" class="rounded border-[#E2E8F0] text-[#16A34A] focus:ring-[#16A34A]">
                <span class="ml-2 text-xs text-[#64748B]">Remember me</span>
            </label>
        </div>
    ...
    <div class="mt-6 text-center text-xs text-[#64748B]">
        Don't have an account? <a href="{{ route('register') }}" class="text-[#16A34A] font-semibold hover:underline">Sign up</a>
    </div>
</div>
