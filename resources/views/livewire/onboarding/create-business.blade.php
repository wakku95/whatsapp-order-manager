    ...
    <form wire:submit.prevent="createBusiness" class="space-y-4">
        <div>
            ...
            <input
                ...
                placeholder="e.g. Modern Fashion Apparel"
            >
        ...
        <div>
            ...
            <select
                id="currency"
                wire:model="currency"
                class="w-full px-3 py-3 border border-[#E2E8F0] rounded-lg text-sm focus:outline-none focus:border-[#16A34A] focus:ring-1 focus:ring-[#16A34A] bg-white"
            >
